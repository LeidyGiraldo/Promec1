"""
Django settings for promec project.
...
WSGI_APPLICATION = 'promec.wsgi.application'
...
LOGIN_REDIRECT_URL = 'modulacion'

LOGIN_URL = '/login/'  # Asegúrate de que esta ruta apunte a tu página de inicio de sesión
